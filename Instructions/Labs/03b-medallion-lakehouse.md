...
1. 작업 영역 설정으로 이동하여 **데이터 모델 편집** 미리 보기 기능을 사용하도록 설정합니다. 이렇게 하면 Power BI 의미 체계 모델을 사용하여 레이크하우스의 테이블 간에 관계를 만들 수 있습니다.
...
1. 방금 만든 작업 영역에서 **+ 새 항목** 버튼을 클릭하여 **영업**이라는 이름의 새 **레이크하우스**를 만듭니다.
