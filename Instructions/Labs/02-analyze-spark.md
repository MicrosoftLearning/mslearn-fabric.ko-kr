...
* [Microsoft Fabric 평가판](/fabric/get-started/fabric-trial#start-the-fabric-capacity-trial).
...
**참고:** Fabric Notebook은 Scala, R, Spark SQL을 비롯한 여러 프로그래밍 언어를 지원합니다.
...
**팁:** « 아이콘을 사용하여 왼쪽의 레이크하우스 탐색기 창을 숨길 수 있습니다. 이렇게 하면 notebook을 사용할 공간이 더 많이 확보됩니다.

5. 셀 왼쪽에 있는 ▷ **셀 실행**을 선택하여 코드를 실행합니다.

**참고:** Spark 코드를 처음 실행할 때는 Spark 세션이 시작됩니다. 몇 초 이상 걸릴 수 있습니다. 동일한 세션 내 후속 실행은 더 빨라집니다.
...
**참고:** 결과 옆의 ...를 선택하여 셀의 출력을 숨기거나 표시할 수 있습니다. 이렇게 하면 notebook 작업이 쉬워집니다.
