...
1. 브라우저에서 [Microsoft Fabric 홈페이지](https://app.fabric.microsoft.com/home?experience=fabric)(`https://app.fabric.microsoft.com/home?experience=fabric`)로 이동합니다.
1. **Synapse 데이터 과학**을 선택합니다.
...
1. 렌더링된 테이블 상단에는 두 개의 탭이 있습니다. **표** 및 **차트**. **차트**를 선택합니다.
1. 시각화를 변경하려면 차트 오른쪽 상단에 있는 **차트 사용자 지정**을 선택합니다.
1. 차트를 다음 설정으로 변경합니다.
    * **차트 유형**: `Box plot`
    * **키**: *비워 둡니다*.
    * **값**: `Y`
1. 새 시각화를 렌더링하고 출력을 탐색하려면 **적용**을 선택합니다.
...
1. 회귀 모델이 정확한지 알아보려면 **메트릭 실행**을 검토합니다.
